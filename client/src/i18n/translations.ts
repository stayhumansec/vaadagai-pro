...
export const translations: Dict = {
  ...
  'tenants.advanceDate': { ta: 'முன்பணம் பெற்ற தேதி', en: 'Advance Collected Date' },
  ...
  'tenants.proofOnFile': { ta: 'ஆவணம் பதிவேற்றப்பட்டுள்ளது', en: 'Proof file on record' },
  'tenants.downloadProof': { ta: '⬇️ பதிவிறக்கு', en: '⬇️ Download' },
  'tenants.proofUploadFailed': { ta: 'ஆவணத்தை பதிவேற்ற முடியவில்லை (PDF/PNG/JPG மட்டும், 10MB வரை)', en: 'Could not upload the proof file (PDF/PNG/JPG only, up to 10MB)' },
  'tenants.proofDownloadFailed': { ta: 'ஆவணத்தை பதிவிறக்க முடியவில்லை', en: 'Could not download the proof file' },
